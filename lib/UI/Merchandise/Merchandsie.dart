...
import 'package:eventid/Adapter/AdapterMerchandise.dart';
                ...
                children: [
                  ListView(
                    ...
                    children: [
                      ...
                      // Delete This
                      FutureBuilder(
                        future: MerchandiseNLP(context, _controller.text),
                        builder: (context, snapshot) {
                          print("Zyarga Decode "+_controller.text);
                          if (snapshot.connectionState == ConnectionState.waiting) {
                            return LoadingContainer(400, 400, "Searching Merchandise");
                            ...
                            return Center(
                              child: Text("No Merchandises found"),
                            );
                          }
                        },
                      ),
                                ...
                                Expanded(
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        "Providing safe, comfortable, and modern Merchandise for land,sea,and air travel",
                                        style: TextStyle(
                                          color: Colors.black,
                                          fontSize: LargeFontSize(),
                                        ),

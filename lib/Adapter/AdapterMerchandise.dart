...
class AdapterMerchandise extends StatefulWidget {
  String id;
  String name;
  String type;
  String image;
  ...
  @override
  State<AdapterMerchandise> createState() => _AdapterMerchandiseState();
}

class _AdapterMerchandiseState extends State<AdapterMerchandise> {
  @override
              ...
              children: [
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    image: DecorationImage(image: NetworkImage(ImageBaseURL('merchandise')+widget.image),fit: BoxFit.fill)
                  ),
                ),
                Padding(

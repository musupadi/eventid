...
class AdapterProduction extends StatefulWidget {
  String id;
  String name;
  String type;
  String image;
  ...
  @override
  State<AdapterProduction> createState() => _AdapterProductionState();
}

class _AdapterProductionState extends State<AdapterProduction> {
  @override
              ...
              children: [
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    image: DecorationImage(image: NetworkImage(ImageBaseURL('production')+widget.image),fit: BoxFit.fill)
                  ),
                ),
                ...
                Padding(
                  ...
                  child: Text(
                    ...
                    softWrap: true, // Mengizinkan teks untuk beralih ke baris berikutnya jika terlalu panjang
                    overflow: TextOverflow.visible, // Mengatur overflow agar teks tidak terpotong
                    maxLines: 2, // Membatasi maksimal 2 baris agar tetap rapi
                  ),
                ),
                Padding(
                  padding: const EdgeInsets.all(10.0),
